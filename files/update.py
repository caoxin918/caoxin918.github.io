...
用法:  python3 files/update.py   (在项目根目录 ScholarHome 下运行)
"""
import re, sys, os

# 获取脚本所在目录 (files/) 和项目根目录 (ScholarHome/)
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_DIR = os.path.dirname(SCRIPT_DIR)

pubs_md_path = os.path.join(SCRIPT_DIR, 'publications.md')
stu_md_path  = os.path.join(SCRIPT_DIR, 'students.md')
