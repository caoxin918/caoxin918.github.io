...
| |
| :---- |
|Bianbian Yang, Yiting He, Nanan Cai, Jun Zhang, Yi Chen※, Yangyang Liu※, Chengyi Gao, Huangjian Yi and **Xin Cao※**. “[Adaptive Bayesian augmented Lagrangian algorithm for Fluorescence Molecular Tomography]( )”, **Journal of the Optical Society of America A**. (2025). |
|**Xin Cao**, Yiting He, Xin Zhou, Jiaxin Du, Yi Chen※, Yangyang Liu※, Chengyi Gao, Huangjian Yi. “[Adagrad-optimized variational Bayesian reconstruction with sparsity-adaptive normal-generalized inverse Gaussian prior for fluorescence molecular tomography]( )”, **Journal of Applied Physics**. (2025). |
...
|**Xin Cao**, Haoyu Wang, Jiaxu Shi, Linzhi Su※, Xinda Liu, Kang Li※. “[Attention-Guided Multi-Scale Local Reconstruction for Point Clouds via Masked Autoencoder Self-Supervised Learning]( )”, **Multimedia Systems**. (2025). |
|**Xin Cao**, Linrong Ye, Xinxin Han, Jia Zhang, Xingxing Hao, Linzhi Su and Kang Li※. “[Self-supervised learning via disentangled representation and self-distillation for 3D terracotta warriors]( )”, **npj Heritage Science**. (2025). |
|Yiting He, Bianbian Yang, Nannan Cai, Yi Chen, Yifan Wang, Huangjian Yi, Xingxing Hao, Chengyi Gao and **Xin Cao※**. “[Cone-beam X-ray luminescence computed tomography via Laplacian scale mixture prior-driven variational Bayesian method]( )”, **Optics Express**. (2025). |
|Bianbian Yang, Yiting He, Nannan Cai, Yi Chen※, Huangjian Yi, Xingxing Hao, Chengyi Gao and **Xin Cao※**. “[Adaptive k-sparse constrained dictionary learning strategy for bioluminescence tomography reconstruction]( )”, **Physics in Medicine & Biology**. (2025). |
|**Xin Cao**, Peiyuan Quan, Yuzhu Mao, Rui Cao※, Linzhi Su, Kang Li. “[TRRS-DM: Two-stage Resampling and Residual Shifting for high-fidelity texture inpainting of Terracotta Warriors utilizing Diffusion Models]( )”, **Pattern Recognition**. (2025). |
